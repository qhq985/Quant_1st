...
ax1.plot(df_new['SC'],color='blue', linewidth=1.0, label='SC1809')
ax1.plot(df_new['Brent_Adj'],color='red', linewidth=1.0, label='Brent')
ax1.plot(df_new['WTI_Adj'],color='green', linewidth=1.0, label='Wti')
...
ax1.plot(df_new['DIFF_Brent_SC'],color='blue', linewidth=1.0, label='DIFF_Brent_SC')
ax1.plot(df_new['DIFF_WTI_SC'],color='red', linewidth=1.0, label='DIFF_WTI_SC')
...
plt.xlabel("time")
# plt.xticks(range(9),['2018/3/26','2018/4/3','2018/4/12','2018/4/19','2018/4/27','2018/5/8','2018/5/15','2018/5/22','2018/5/29'])
plt.show()
